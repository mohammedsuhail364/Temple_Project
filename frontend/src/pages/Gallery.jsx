...
const Gallery = () => {
  return (
    ...
    <p className="text-lg text-center text-gray-700 mb-12">
      இந்தப் பக்கத்தில், நமது திருக்கோவிலின் புகைப்படங்களைக் காணலாம். 
      இவற்றில் ஆலயத்தின் அழகிய வடிவமைப்புகள், பண்டிகைகள் மற்றும் பூஜைகள் 
      ஆகியவை உள்ளன. இவை ஒவ்வொன்றும் திருக்கோவிலின் ஆன்மிகம் மற்றும் பாரம்பரியத்தை 
      ...
      {images.map((image, index) => (
        ...
        >
          ...
          <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-center items-center text-white">
            ...
            <p className="text-sm mb-4">{image.description}</p>  {/* Description */}
