  ...
  return (
    <div className="p-6 max-w-5xl mx-auto mt-32 bg-white rounded-lg shadow-md">
      ...
      <div className="text-gray-800 text-justify">
        ...
        <p className="text-lg mb-4">
          இந்த ஆலயம் சுமார் 150 முதல் 200 ஆண்டுகள் பழமை வாய்ந்ததாக 
          அப்பகுதி மக்களால் நம்பப்படுகின்றது.
        </p>
        <p className="text-lg mb-4">
          ...
          சுமார் 31 கிலோமீட்டர் தொலைவிலும் திருச்செந்தூரில் இருந்து சுமார் 
          44 கிலோமீட்டர் தொலைவிலும் அமைந்துள்ளது.
        </p>
        <p className="text-lg">
          இதில் திருநெல்வேலி, வள்ளியூர், நாங்குநேரி, திருச்செந்தூர் போன்ற 
          அனைத்து சுற்றுவட்டார நகரங்களிலும் இரயில் சேவை உள்ளது. எனவே 
          அங்கிருந்து திசையன்விளை செல்லும் பேருந்துகள் மூலம் எளிதில் திருக்கோவிலை வந்தடையலாம்.
        </p>
      </div>
