    ...
    <div className="flex flex-col lg:flex-row items-center justify-center text-center p-4 lg:p-6 bg-amber-50 shadow-xl rounded-lg space-y-4 lg:space-y-0 lg:space-x-6 mt-5 max-w-5xl mx-auto pt-20 mb-10">
      ...
      >
        ...
        <p className="text-sm text-gray-700 leading-relaxed text-justify mb-4">
          நமது திருவாலயத்தில் ஆண்டுதோறும் நடைபெறும் வருஷாபிஷேகம் மற்றும்
          நவராத்திரி திருவிழாவின் போது பக்தர்களுக்கு அன்னதானம் வழங்கப்படுகிறது,
          இந்த சேவை தங்கு தடையின்றி நடைபெற அன்னதான நிரந்தர வைப்பு நிதிக்கு
          உங்கள் பங்களிப்பை தந்து இறையருள் பெறுமாறு அன்புடன் கேட்டுக் கொள்கிறோம்
        </p>
